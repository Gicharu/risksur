...
/**
 * This is the model class for table "evalQuestionOptions".
 *
 * The followings are the available columns in table 'evalQuestionOptions':
 * @property string $id
 ...
 */
class EvalQuestionOptions extends CActiveRecord
{
	/**
