			...
			$this->menu = array(
				array('label' => Yii::t("translation", "Introduction to Evaluation of Surveillance "), 'url' => array('evaPage'),
				      'items' => array(
					      ...
					      array('label' => 'Economic Evaluation methods', 'url' => array("$currentController/evaMethods")),
				...
				array('label' => Yii::t("translation", "Evaluation attributes and economic criteria"),
					...
					array('label' => Yii::t("translation", "Epidemiological assessment"), 'url' => array("$currentController/index")),
					array('label' => 'Final list of attributes', 'url' => array("$currentController/index"))
				),
				),

				array('label' => Yii::t("translation", "Summary and Report"), 'url' => array("$currentController/index")),
			);
		}
