...
$evaluationQuestions = CHtml::listData(EvaluationQuestion::model()->findAll('flag=:flag', [':flag' => 'final']),
	'evalQuestionId', function($question) {
...
?>
	...
	<div class="row">
		...
		<?php echo $form->dropdownlist($model,'method', $economicMethods, ['class' => 'chozen']); ?>
		<?php echo $form->error($model,'method'); ?>
	</div>

	<div class="row">
		<?php echo $form->labelEx($model,'questions'); ?>
		<?php echo $form->dropdownlist($model,'questions', $evaluationQuestions,
			[
				'class' => 'chozen',
				'multiple' => 'multiple',
				'style' => 'width:40em'
